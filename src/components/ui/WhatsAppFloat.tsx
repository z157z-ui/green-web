...
export function WhatsAppFloat({
  ...
  return (
    ...
    >
      ...
      {/* Main Button */}
      <div className="relative w-14 h-14 bg-[#25D366] hover:bg-[#20BA5A] rounded-full flex items-center justify-center shadow-2xl transition-all duration-300">
